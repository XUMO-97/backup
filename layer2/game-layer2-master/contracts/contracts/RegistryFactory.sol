...
contract RegistryFactory {
    ...
    */
    function newRegistryBYOToken(
        ...
        Parameterizer parameterizer = parameterizerFactory.newParameterizerBYOToken(msg.sender, _token, _parameters, _operator);
    ...
    */
    function newRegistryWithToken(
        ...
        Parameterizer parameterizer = parameterizerFactory.newParameterizerWithToken(msg.sender, _supply, _tokenName, _decimals, _symbol, _parameters, _operator);
