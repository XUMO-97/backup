...
def run(file_path, file_name):
    ...
    Compiler.Compile(template_file_name_py)
...
if __name__ == '__main__':
    ...
    template_file_path = "./layer2/"
    template_file_name = "Registry"
    # template_file_name = "Parameterizer"
    # template_file_name = "PLCRVoting"
