...
luckyMoonContractAddress = "6c3f7b597c0f320cbcabaf2157e21ed36e8a0835"
    ...
    def test_init(self):
        ...
        for event in events:
            ...
            if event["ContractAddress"] == luckyMoonContractAddress:
                notifyContent.append((bytearray.fromhex(event["States"][0])).decode('utf-8'))
            ...
            for event in events:
                ...
                if event["ContractAddress"] == luckyMoonContractAddress:
                    ...
                    if first == "bet":
                        ...
                        account = Address(binascii.a2b_hex(event["States"][1]))
                ...
                if event["ContractAddress"] == luckyMoonContractAddress:
                    ...
                    if first == "endCurrentRound":
                        ...
                        for effectiveEscapeAcctPointOddsProfit in effectiveEscapeAcctPointOddsProfitList:
                            ...
                            profit = effectiveEscapeAcctPointOddsProfit[3]
                            if not profit:
                                profit = "0"
