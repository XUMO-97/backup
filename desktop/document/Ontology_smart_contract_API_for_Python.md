...
|              boa.interop.Ontology.Native |                    Invoke | version, contractAddress, method, args                       | invoke native contract |
...
|             boa.interop.Ontology.Runtime | GetCurrentBlockHash |                                                    | get current block hash |
...
|                boa.interop.System.Action |            RegisterAction |                                  event_name, *args | register a notify event |
...
|            boa.interop.System.Blockchain | GetTransactionByHash |                                               hash | get transaction by hash |
|            boa.interop.System.Blockchain |               GetContract |                                        script_hash | get contract by script hash |
| boa.interop.System.Blockchain | GetTransactionHeight | hash | get transaction height by hash |
...
|                 boa.interop.System.Block | GetTransactionByIndex |                                       block, index | get the transaction by index |
...
|                boa.interop.System.Header |       GetBlockHash |                                             header | get the hash of header |
